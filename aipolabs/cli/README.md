...
In most cases you should execute the commands via the `runner` container. Note that most commands can take a `--quiet` flag to suppress output if desired, especially useful when running evals.
e.g.,
```bash
